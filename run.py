...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', '--intensity_thresh', type=str, help='Intensity threshold to capture seeds. Format is <brightfield_thresh>,<fluorescent_thresh>. Example: "30,30". Default: None', default=None)
    ...
    parser.add_argument('--mode', type=str, choices=[CountMethod.FLUORESCENCE.value, CountMethod.COLOR.value], default=CountMethod.FLUORESCENCE.value, help='Counting mode to use.')
    parser.add_argument('--radial_threshold_ratio', type=float, default=0.4, help='Compute the radial threshold as a ratio of the median area of the seeds. Default: 0.4')
